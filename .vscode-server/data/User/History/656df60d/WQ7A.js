        ...
        <div className='container about-page'>
            ...
            <div className='stage-cube-cont'>
                <div className='cubespinner'>
                    <div className='logo1'>
                        <FontAwesomeIcon src={logo1} color='#DD0031'><img /></FontAwesomeIcon>
                    </div>
                    <div className='logo2'>
                        <FontAwesomeIcon color='#DD0031'><img src={logo2} /></FontAwesomeIcon>
                    </div>
                    <div className='logo3'>
                        <FontAwesomeIcon color='#DD0031'><img src={logo3} /></FontAwesomeIcon>
                    </div>
                    <div className='logo4'>
                        <FontAwesomeIcon color='#DD0031'><img src={logo4} /></FontAwesomeIcon>
                    </div>
                    <div className='logo5'>
                        <FontAwesomeIcon color='#DD0031'><img src={logo5} /></FontAwesomeIcon>
                    </div>
                    <div className='logo6'>
                        <FontAwesomeIcon color='#DD0031'><img src={logo6} /></FontAwesomeIcon>
                    </div>
                </div>
            </div>
        </div>
