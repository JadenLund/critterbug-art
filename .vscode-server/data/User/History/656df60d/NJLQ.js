...
import { logo1, logo2, logo3, logo4, logo5, logo6 } from '../../images/logo1.png'
        ...
        <div className='container about-page'>
            ...
            <div className='stage-cube-cont'>
                <div className='cubespinner'>
                    <div className='logo1'>
                        <FontAwesomeIcon icon={logo1} color='#DD0031'></FontAwesomeIcon>
                    </div>
                    <div className='logo2'>
                        <FontAwesomeIcon icon={logo2} color='#DD0031'></FontAwesomeIcon>
                    </div>
                    <div className='logo3'>
                        <FontAwesomeIcon icon={logo3} color='#DD0031'></FontAwesomeIcon>
                    </div>
                    <div className='logo4'>
                        <FontAwesomeIcon icon={logo4} color='#DD0031'></FontAwesomeIcon>
                    </div>
                    <div className='logo5'>
                        <FontAwesomeIcon icon={logo5} color='#DD0031'></FontAwesomeIcon>
                    </div>
                    <div className='logo6'>
                        <FontAwesomeIcon icon={logo6} color='#DD0031'></FontAwesomeIcon>
                    </div>
                </div>
            </div>
        </div>
